...
class OhlcvEnv(gym.Env):
    ...
    def load_from_csv(self):
        ...
        extrator = process_data.FeatureExtractor(raw_df)
        self.df = extrator.add_bar_features() # bar features o, h, l, c ---> C(4,2) = 4*3/2*1 = 6 features
    ...
    def step(self, action):
        ...
        # [coin + krw_won] total value evalutated in krw won
